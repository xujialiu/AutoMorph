...
AUTOMORPH_DATA = os.getenv("AUTOMORPH_DATA", "AUTOMORPH_DATA")
...
if __name__ == "__main__":
    ...
    for i in range(1):
        net_G_1.load_state_dict(
            torch.load(checkpoint_saved_1 + "CP_best_F1_all.pth", map_location=device)
        )
        net_G_A_1.load_state_dict(
            torch.load(checkpoint_saved_1 + "CP_best_F1_A.pth", map_location=device)
        )
        net_G_V_1.load_state_dict(
            torch.load(checkpoint_saved_1 + "CP_best_F1_V.pth", map_location=device)
        )
        net_G_1.eval()
        net_G_A_1.eval()
        net_G_V_1.eval()
        ...
        net_G_2.load_state_dict(
            torch.load(checkpoint_saved_2 + "CP_best_F1_all.pth", map_location=device)
        )
        net_G_A_2.load_state_dict(
            torch.load(checkpoint_saved_2 + "CP_best_F1_A.pth", map_location=device)
        )
        net_G_V_2.load_state_dict(
            torch.load(checkpoint_saved_2 + "CP_best_F1_V.pth", map_location=device)
        )
        net_G_2.eval()
        net_G_A_2.eval()
        net_G_V_2.eval()
        ...
        net_G_3.load_state_dict(
            torch.load(checkpoint_saved_3 + "CP_best_F1_all.pth", map_location=device)
        )
        net_G_A_3.load_state_dict(
            torch.load(checkpoint_saved_3 + "CP_best_F1_A.pth", map_location=device)
        )
        net_G_V_3.load_state_dict(
            torch.load(checkpoint_saved_3 + "CP_best_F1_V.pth", map_location=device)
        )
        net_G_3.eval()
        net_G_A_3.eval()
        net_G_V_3.eval()
        ...
        net_G_4.load_state_dict(
            torch.load(checkpoint_saved_4 + "CP_best_F1_all.pth", map_location=device)
        )
        net_G_A_4.load_state_dict(
            torch.load(checkpoint_saved_4 + "CP_best_F1_A.pth", map_location=device)
        )
        net_G_V_4.load_state_dict(
            torch.load(checkpoint_saved_4 + "CP_best_F1_V.pth", map_location=device)
        )
        net_G_4.eval()
        net_G_A_4.eval()
        net_G_V_4.eval()
        ...
        net_G_5.load_state_dict(
            torch.load(checkpoint_saved_5 + "CP_best_F1_all.pth", map_location=device)
        )
        net_G_A_5.load_state_dict(
            torch.load(checkpoint_saved_5 + "CP_best_F1_A.pth", map_location=device)
        )
        net_G_V_5.load_state_dict(
            torch.load(checkpoint_saved_5 + "CP_best_F1_V.pth", map_location=device)
        )
        net_G_5.eval()
        net_G_A_5.eval()
        net_G_V_5.eval()
        ...
        net_G_6.load_state_dict(
            torch.load(checkpoint_saved_6 + "CP_best_F1_all.pth", map_location=device)
        )
        net_G_A_6.load_state_dict(
            torch.load(checkpoint_saved_6 + "CP_best_F1_A.pth", map_location=device)
        )
        net_G_V_6.load_state_dict(
            torch.load(checkpoint_saved_6 + "CP_best_F1_V.pth", map_location=device)
        )
        net_G_6.eval()
        net_G_A_6.eval()
        net_G_V_6.eval()
        ...
        net_G_7.load_state_dict(
            torch.load(checkpoint_saved_7 + "CP_best_F1_all.pth", map_location=device)
        )
        net_G_A_7.load_state_dict(
            torch.load(checkpoint_saved_7 + "CP_best_F1_A.pth", map_location=device)
        )
        net_G_V_7.load_state_dict(
            torch.load(checkpoint_saved_7 + "CP_best_F1_V.pth", map_location=device)
        )
        net_G_7.eval()
        net_G_A_7.eval()
        net_G_V_7.eval()
        ...
        net_G_8.load_state_dict(
            torch.load(checkpoint_saved_8 + "CP_best_F1_all.pth", map_location=device)
        )
        net_G_A_8.load_state_dict(
            torch.load(checkpoint_saved_8 + "CP_best_F1_A.pth", map_location=device)
        )
        net_G_V_8.load_state_dict(
            torch.load(checkpoint_saved_8 + "CP_best_F1_V.pth", map_location=device)
        )
        net_G_8.eval()
        net_G_A_8.eval()
        net_G_V_8.eval()
