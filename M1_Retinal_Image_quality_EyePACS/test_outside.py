...
def test_net(
    ...
    # storage_path = "Ensemble_exp_{}/{}/train_on_{}/test_on_{}/".format(
    #     args.task, args.load, args.model, args.dataset
    # )
...
if __name__ == "__main__":
    ...
    if args.load:
        model_fl_1.load_state_dict(torch.load(checkpoint_path_1, map_location=device))
        model_fl_2.load_state_dict(torch.load(checkpoint_path_2, map_location=device))
        model_fl_3.load_state_dict(torch.load(checkpoint_path_3, map_location=device))
        model_fl_4.load_state_dict(torch.load(checkpoint_path_4, map_location=device))
        model_fl_5.load_state_dict(torch.load(checkpoint_path_5, map_location=device))
        model_fl_6.load_state_dict(torch.load(checkpoint_path_6, map_location=device))
        model_fl_7.load_state_dict(torch.load(checkpoint_path_7, map_location=device))
        model_fl_8.load_state_dict(torch.load(checkpoint_path_8, map_location=device))
